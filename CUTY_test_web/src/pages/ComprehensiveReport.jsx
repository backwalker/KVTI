...
export default function ComprehensiveReport() {
    ...
    const reportData = generateReportData(currentResultCode, passedState);
            ...
            <main className="pt-32 px-4 sm:px-12 md:px-24 max-w-4xl mx-auto space-y-24 bg-white shadow-[0_0_50px_rgba(0,0,0,0.05)] print:shadow-none print:pt-0">
                        ...
                        <div className="space-y-4 font-sans focus:outline-none">
                            ...
                            {passedState?.dashboard?.careerVitalityIndex && (
                                <div className="flex items-center gap-4 mt-2 group relative">
                                    <span className="text-sm font-bold text-slate-500 uppercase tracking-widest w-24">커리어 선명도</span>
                                    ...
                                    <span className="text-sm font-bold text-slate-800 ml-2">{passedState.dashboard.careerVitalityIndex}점</span>
                                </div>
                            )}
                        </div>
                ...
                <section className="space-y-8 leading-loose text-lg text-slate-800">
                    ...
                    <p className="indent-8 text-justify">
                        KVTI(Korea Visa Type Indicator) 분석 모델은 최신 한국 노동 시장의 트렌드 데이터와 심리학적 행동 지표를 기반으로 설계된 초정밀 커리어 진단 시스템입니다. 외국인 유학생이 한국 사회에서 자신의 강점을 발휘하기 위해 필수적으로 요구되는 핵심 진단 지표(산업 적합도, 직무 성향, 조직 문화 융화력 등)를 다각도에서 분석하여 지원자 고유의 성향 지도를 도출합니다.
                    </p>
                    <p className="indent-8 text-justify">
                        본 진단 보고서는 지원자의 잠재력을 가장 잘 시너지화 할 수 있는 페르소나를 매칭합니다. 이를 바탕으로 <strong>대한민국 법무부가 공식적으로 허가한 체류 자격(전문취업 E-7, 기술창업 D-8, 우수인재거주 F-2 등)의 광범위한 범주 내에서, 제약 조건을 극복하고 지원자의 성향과 가치관에 가장 완벽하게 부합하는 최적의 커리어 패스</strong>를 찾아냅니다. 이 보고서에 담긴 분석과 추천 로드맵은 {userName}님이 한국이라는 낯선 환경 속에서 어떻게 자신만의 고유한 무기를 활용하여 최고의 직무 만족도를 달성할 수 있을지에 대한 가장 현실적이고 주도적인 해답이 될 것입니다.
                    </p>
                </section>
                    ...
                    {localizedRadarData && localizedRadarData.length > 0 && (
                        <div className="mb-12 bg-white border border-slate-200 p-8 md:p-12 shadow-sm rounded-xl print:shadow-none print:border-slate-300">
                            <h3 className="text-xl font-bold text-slate-900 mb-6 font-sans flex items-center gap-3 border-b border-slate-100 pb-4">
                                <Target className="w-6 h-6 shrink-0 text-indigo-600" /> 종합 커리어 흥미도 (RIASEC 다차원 모델)
                            </h3>
                                    ...
                                    <div className="w-full grid grid-cols-1 sm:grid-cols-2 gap-3 text-sm">
                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-indigo-200 transition-colors">
                                            <div className="font-extrabold text-indigo-700 flex items-center gap-2 mb-1">
                                                <span className="bg-indigo-100 text-indigo-800 text-xs px-2 py-0.5 rounded">R</span>현실형 (Realistic)
                                            </div>
                                            <p className="text-slate-600 leading-snug">현장 중심·가시적 결과물 선호 (제조, 기계, 설비, 뿌리산업 최적화)</p>
                                        </div>
                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-indigo-200 transition-colors">
                                            <div className="font-extrabold text-indigo-700 flex items-center gap-2 mb-1">
                                                <span className="bg-indigo-100 text-indigo-800 text-xs px-2 py-0.5 rounded">I</span>탐구형 (Investigative)
                                            </div>
                                            <p className="text-slate-600 leading-snug">데이터 분석·논리적 접근 선호 (IT, 연구지식, 데이터, 프로그래밍 최적화)</p>
                                        </div>
                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-indigo-200 transition-colors">
                                            <div className="font-extrabold text-indigo-700 flex items-center gap-2 mb-1">
                                                <span className="bg-indigo-100 text-indigo-800 text-xs px-2 py-0.5 rounded">A</span>예술형 (Artistic)
                                            </div>
                                            <p className="text-slate-600 leading-snug">창의성·사용자(UX) 및 심미성 중시 (디자인, 콘텐츠, 마케팅, 미디어 최적화)</p>
                                        </div>
                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-indigo-200 transition-colors">
                                            <div className="font-extrabold text-indigo-700 flex items-center gap-2 mb-1">
                                                <span className="bg-indigo-100 text-indigo-800 text-xs px-2 py-0.5 rounded">S</span>사회형 (Social)
                                            </div>
                                            <p className="text-slate-600 leading-snug">이해심·소통 및 협업 역량 우수 (서비스, 교육, 의료지원, 인사/CS 최적화)</p>
                                        </div>
                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-indigo-200 transition-colors">
                                            <div className="font-extrabold text-indigo-700 flex items-center gap-2 mb-1">
                                                <span className="bg-indigo-100 text-indigo-800 text-xs px-2 py-0.5 rounded">E</span>진취형 (Enterprising)
                                            </div>
                                            <p className="text-slate-600 leading-snug">목표 지향·리더십 및 추진력 발휘 (경영, 무역영업, 글로벌사업 추진 최적화)</p>
                                        </div>
                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-indigo-200 transition-colors">
                                            <div className="font-extrabold text-indigo-700 flex items-center gap-2 mb-1">
                                                <span className="bg-indigo-100 text-indigo-800 text-xs px-2 py-0.5 rounded">C</span>관습형 (Conventional)
                                            </div>
                                            <p className="text-slate-600 leading-snug">규칙 준수·오차 없는 행정력 강점 (재무회계, 생산관리, 문서지원 최적화)</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div key={section.id || index} className="space-y-4">
                                                ...
                                                <div className="bg-white p-6 md:p-8 rounded-xl border border-slate-100 shadow-sm mt-4">
                                                    <div className="flex justify-between items-end mb-8">
                                                        <div className="flex items-center gap-4">
                                                            ...
                                                            <div>
                                                                <div className="text-sm font-bold text-slate-500 uppercase tracking-wider">종합 커리어 선명도 (Career Clarity Index)</div>
                                                                <div className="text-4xl font-black text-slate-900 mt-1 flex items-baseline gap-1">{passedState?.dashboard?.careerVitalityIndex || 50}<span className="text-base font-bold text-slate-400 ml-1">점</span></div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div className="relative pt-2 pb-6 px-1">
                                                        ...
                                                        <div className="absolute -top-5 left-0 w-full text-[11px] font-bold text-slate-400">
                                                            <div className="absolute left-[20%] -translate-x-1/2">재정립기</div>
                                                            <div className="absolute left-[50%] -translate-x-1/2 text-sky-600">탐색기</div>
                                                            <div className="absolute left-[70%] -translate-x-1/2 text-indigo-500">안정권</div>
                                                            <div className="absolute left-[90%] -translate-x-1/2 text-indigo-700">확립기</div>
                                                        </div>
                                            ...
                                            {section.id === 'style' && (
                                                <div className="space-y-4">
                                                    {renderChart(
                                                        "세부 업무 스타일 (Work Style)",
                                                        styleData,
                                                        { 'A': '분석(A)', 'C': '창의(C)', 'P': '현장(P)', 'E': '리더(E)' },
                                                    ...
                                                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-4 text-sm">
                                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-rose-200 transition-colors">
                                                            <div className="font-extrabold text-rose-700 flex items-center gap-2 mb-1">
                                                                <span className="bg-rose-100 text-rose-800 text-xs px-2 py-0.5 rounded">A</span>분석형 (Analyst)
                                                            </div>
                                                            <p className="text-slate-600 leading-snug">데이터 기반으로 치밀하고 꼼꼼하게 문제를 해결하는 스타일</p>
                                                        </div>
                                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-rose-200 transition-colors">
                                                            <div className="font-extrabold text-rose-700 flex items-center gap-2 mb-1">
                                                                <span className="bg-rose-100 text-rose-800 text-xs px-2 py-0.5 rounded">C</span>창의형 (Creator)
                                                            </div>
                                                            <p className="text-slate-600 leading-snug">새로운 아이디어를 기획하고 독창적인 결과물을 만드는 스타일</p>
                                                        </div>
                                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-rose-200 transition-colors">
                                                            <div className="font-extrabold text-rose-700 flex items-center gap-2 mb-1">
                                                                <span className="bg-rose-100 text-rose-800 text-xs px-2 py-0.5 rounded">P</span>현장형 (Practical)
                                                            </div>
                                                            <p className="text-slate-600 leading-snug">직접 몸으로 부딪히며 현장의 실무를 빠르고 정확하게 처리하는 스타일</p>
                                                        </div>
                                                        <div className="bg-slate-50 p-4 rounded-xl border border-slate-100 hover:border-rose-200 transition-colors">
                                                            <div className="font-extrabold text-rose-700 flex items-center gap-2 mb-1">
                                                                <span className="bg-rose-100 text-rose-800 text-xs px-2 py-0.5 rounded">E</span>리더형 (Execution)
                                                            </div>
                                                            <p className="text-slate-600 leading-snug">타인을 설득하고 프로젝트를 주도적으로 이끌어가는 실행 중심 스타일</p>
                                                        </div>
                                                    </div>
                                                </div>
                                            )}
                ...
                <section className="space-y-16 leading-loose text-lg text-slate-800 page-break-before">
                    <h2 className="text-2xl font-black text-slate-900 border-l-4 border-indigo-600 pl-4 mb-16 font-sans">
                        III. 매칭 완료: 성향 기반 최적 진로 및 대표 직무 가이드
                    </h2>

                    <p className="text-justify mb-16">
                        앞서 진행된 성향 분석 모형을 알고리즘으로 매칭하여, 응답자의 성향 및 가치관과 가장 잘 부합하는 상위 3개의 전략적 접근 직군을 도출하였습니다. 본 가이드는 현실적인 취업 비자(E-7 등) 취득 모델을 기준으로 작성되었으나, 개인의 역량과 조건에 따라 창업(D-8) 및 장기 체류(F-시리즈) 등 다각도의 진로 확장성을 내포하고 있습니다. 아래 각 항목은 해당 직군에 진입하기 위한 <strong>법무부 공식 사증 심사 기준의 예시</strong>와, 잠재력을 극대화하기 위해 미리 계획해야 할 <strong>실전 코어 역량 가이드라인</strong>입니다.
                    </p>
                            ...
                            <div key={idx} className="relative">
                                ...
                                {job.specialNote && (
                                    <div className="mb-10 bg-amber-50 border border-amber-200 rounded-2xl p-6 shadow-sm flex items-start gap-4">
                                        ...
                                        <div>
                                            <h4 className="text-lg font-bold text-amber-900 mb-2 font-sans">유학생 특별 진입 전략 가이드</h4>
                                ...
                                <div className="space-y-8">
                                    ...
                                    <div>
                                        <h4 className="text-lg font-bold text-slate-900 mb-3 flex items-center gap-2 font-sans mt-10">
                                            <Target className="w-5 h-5 text-indigo-600" /> [3] 비자취득 및 관련 산업 취업을 위한 전략적 핵심 역량 (Core Competency)
                                        </h4>
                                        <ul className="mb-8 space-y-6">
                                            ...
                                            {job.certifications && job.certifications.length > 0 && (
                                                <li className="flex items-start gap-4">
                                                    <CheckCircle2 className="w-6 h-6 text-emerald-600 shrink-0 mt-1" />
                                                    <div className="text-justify font-sans text-slate-700">
                                                        <strong>권장 자격 및 면허 요건:</strong> {job.certifications.join(', ')} 등의 직무 관련 전문 자격 취득을 통해 역량을 공식화하는 것이 강력히 권장됩니다.
                                                    </div>
                                                </li>
                                            )}
                                            {job.tools && job.tools.length > 0 && (
                                                <li className="flex items-start gap-4">
                                                    <CheckCircle2 className="w-6 h-6 text-emerald-600 shrink-0 mt-1" />
                                                    <div className="text-justify font-sans text-slate-700">
                                                        <strong>실무 기술 스택 및 활용 툴:</strong> 채용 직후 현업에 즉시 투입될 수 있도록 {job.tools.join(', ')} 등의 핵심 소프트웨어 및 장비 운용 능력을 필수적으로 갖추어야 합니다.
                                                    </div>
                                                </li>
                                            )}
                                            {job.portfolio && job.portfolio.length > 0 && (
                                                <li className="flex items-start gap-4">
                                                    <CheckCircle2 className="w-6 h-6 text-emerald-600 shrink-0 mt-1" />
                                                    <div className="text-justify font-sans text-slate-700">
                                                        <strong>실전 포트폴리오 구축 방향성:</strong> 입사 보장률을 높이기 위해 {job.portfolio.join(', ')} 등과 같은 구체적이고 실증적인 실무 프로젝트 결과물을 선제적으로 구축하여 객관적 증빙 자료로 활용해야 합니다.
                                                    </div>
                                                </li>
                                            )}
                                        </ul>
                                        ...
                                        return (
                                            <div>
                                                <h4 className="text-lg font-bold text-slate-900 mb-4 flex items-center gap-2 font-sans mt-12 border-t border-slate-200 pt-8">
                                                    <Target className="w-5 h-5 text-indigo-600" /> [4] 단계별 비자 서바이벌 통합 로드맵 (Actionable Timeline)
                                                </h4>
                                                <div className="space-y-6">
                                                    ...
                                                    <blockquote className="mt-6 border-l-4 border-rose-500 bg-rose-50 p-4 text-rose-900 rounded-r-lg font-sans">
                                                        <strong className="block mb-1 flex items-center gap-2">
                                                            <span className="text-lg">🚨</span> 법무부 체류 자격 박탈 (Red Flag) 사전 경고
                                                        </strong>
                                                        <span className="text-sm leading-relaxed">
                                                            진로 준비 중 단 100만 원 미만의 가벼운 범칙금(무단횡단, 전동킥보드 불법운행, 불법 아르바이트 등) 납부 기록이 발생하더라도, 향후 F-2-7 거주 비자 전환 시 치명적인 감점 요소로 작용하여 한국 내 장기 정주가 원천적으로 차단될 수 있습니다. 엄격한 법규 준수는 커리어 설계의 최우선 기본 스펙입니다.
                                                        </span>
                                                    </blockquote>
                                                </div>
                                            </div>
                ...
                <section className="space-y-8 leading-loose text-lg text-slate-800 page-break-before pb-24">
                    ...
                    <p className="indent-8 text-justify mt-6">
                        당사는 {userName}님의 성공적인 정착을 지원하기 위하여, 본 진단 결과를 토대로 한 <strong>'개인 맞춤형 시계열 로드맵 구축 시스템(Comprehensive Timeline Builder)'</strong>을 향후 정비하여 제공할 예정입니다. 1학년 1학기부터 상시 퀘스트 기반으로 제공될 이 시스템을 통해 체계적인 한국 생활 설계를 완성하시기 바랍니다.
                    </p>
