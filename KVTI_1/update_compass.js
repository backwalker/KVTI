const fs = require('fs');
const file = 'src/components/LandingDetails.jsx';
let content = fs.readFileSync(file, 'utf8');

const replacement = `<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 200 200" className="w-[150%] h-[150%] md:w-[120%] md:h-[120%] text-cyan-300 animate-[spin_160s_linear_infinite]" fill="none" stroke="currentColor">
                            {/* Outer Clean Ring */}
...
const regex = /<svg xmlns="http:\/\/www\.w3\.org\/2000\/svg" viewBox="0 0 200 200" className="w-\[150%\] h-\[150%\] md:w-\[120%\] md:h-\[120%\] text-cyan-300 animate-\[spin_160s_linear_infinite\]" fill="none" stroke="currentColor">[\s\S]*?<\/svg>/;
